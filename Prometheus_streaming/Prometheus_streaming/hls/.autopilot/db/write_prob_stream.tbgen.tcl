...
set C_modelArgList {
	...
	{ pr_w int 30 regular {ap_stable 0} }
	{ n int 9 regular {ap_stable 0} }
	{ prob_stream int 32 regular {fifo 0 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "mem", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "pr_w", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
 	{ "Name" : "n", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "prob_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ prob_stream_dout sc_in sc_lv 32 signal 4 } 
	{ prob_stream_empty_n sc_in sc_logic 1 signal 4 } 
	{ prob_stream_read sc_out sc_logic 1 signal 4 } 
	{ prob_stream_num_data_valid sc_in sc_lv 6 signal 4 } 
	{ prob_stream_fifo_cap sc_in sc_lv 6 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "prob_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "prob_stream", "role": "dout" }} , 
 	...
 	{ "name": "prob_stream_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "prob_stream", "role": "num_data_valid" }} , 
 	{ "name": "prob_stream_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "prob_stream", "role": "fifo_cap" }} , 
 	...
 	{ "name": "pr_w", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "pr_w", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "264"}
	, {"Name" : "Interval", "Min" : "9", "Max" : "264"}
]}
...
set Spec2ImplPortList { 
	...
	mem { ap_stable {  { mem in_data 0 64 } } }
	pr_w { ap_stable {  { pr_w in_data 0 30 } } }
	n { ap_stable {  { n in_data 0 9 } } }
	prob_stream { ap_fifo {  { prob_stream_dout fifo_data_in 0 32 }  { prob_stream_empty_n fifo_status 0 1 }  { prob_stream_read fifo_port_we 1 1 }  { prob_stream_num_data_valid fifo_status_num_data_valid 0 6 }  { prob_stream_fifo_cap fifo_update 0 6 } } }
}
