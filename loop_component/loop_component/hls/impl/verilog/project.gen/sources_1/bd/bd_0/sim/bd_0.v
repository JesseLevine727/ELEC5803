...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MEM_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MEM_ADDRESS0, LAYERED_METADATA undef" *) output [15:0]mem_address0;
  output mem_ce0;
  ...
  output mem_we0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PSTRB DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PSTRB, LAYERED_METADATA undef" *) input [3:0]pstrb;
