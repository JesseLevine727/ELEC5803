...
//
//==============================================================
`ifndef PROMETHEUS_SOC_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define PROMETHEUS_SOC_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class prometheus_soc_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "prometheus_soc_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(prometheus_soc_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(prometheus_soc_virtual_sequencer)                                     
        ...
        virtual task body();                                                                        
            ...
            if (!uvm_config_db#(prometheus_soc_reference_model)::get(p_sequencer,"", "refm", refm))
