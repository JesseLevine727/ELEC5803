...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler softmax_accel_fifo_w32_d32_S_x BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {prob_stream_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler softmax_accel_start_for_write_prob_stream_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_write_prob_stream_U0_U}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename exp_buf \
    op interface \
    ports { exp_buf_address0 { O 8 vector } exp_buf_ce0 { O 1 bit } exp_buf_d0 { O 32 vector } exp_buf_q0 { I 32 vector } exp_buf_we0 { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_mem \
    op interface \
    ports { mem { I 64 vector } mem_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_pr_w \
    op interface \
    ports { pr_w { I 30 vector } pr_w_ap_vld { I 1 bit } } \
} "
}
