set moduleName softmax_accel_Pipeline_VITIS_LOOP_188_2
set isTopModule 0
...
set cdfgNum 6
set C_modelName {softmax_accel_Pipeline_VITIS_LOOP_188_2}
...
set C_modelArgList {
	...
	{ select_ln169 int 9 regular  }
	{ sext_ln176 int 62 regular  }
	{ max_x_1_reload int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "select_ln169", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln176", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "max_x_1_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln169 sc_in sc_lv 9 signal 1 } 
	{ sext_ln176 sc_in sc_lv 62 signal 2 } 
	{ max_x_1_reload sc_in sc_lv 32 signal 3 } 
	{ exp_buf_address0 sc_out sc_lv 8 signal 4 } 
	{ exp_buf_ce0 sc_out sc_logic 1 signal 4 } 
	{ exp_buf_we0 sc_out sc_logic 1 signal 4 } 
	{ exp_buf_d0 sc_out sc_lv 32 signal 4 } 
	{ sum64_out sc_out sc_lv 40 signal 5 } 
	{ sum64_out_ap_vld sc_out sc_logic 1 outvld 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln169", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "select_ln169", "role": "default" }} , 
 	{ "name": "sext_ln176", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln176", "role": "default" }} , 
 	{ "name": "max_x_1_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_x_1_reload", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	select_ln169 { ap_none {  { select_ln169 in_data 0 9 } } }
	sext_ln176 { ap_none {  { sext_ln176 in_data 0 62 } } }
	max_x_1_reload { ap_none {  { max_x_1_reload in_data 0 32 } } }
