...
#pragma HLS INLINE
 if (sum_q16 == 0) return 0x7FFFFFFF;
  ...
  int msb = 31;
  VITIS_LOOP_92_1: for (int b = 31; b >= 0; --b) {
#pragma HLS UNROLL
 if (sum_q16[b]) {
      msb = b;
      break;
...
#pragma HLS INLINE
 int msb = 31;
  VITIS_LOOP_247_1: for (int b = 31; b >= 0; --b) {
#pragma HLS UNROLL
 if (sum_q16[b]) {
      msb = b;
      break;
