...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.softmax_accel.autotvin_gmem.dat"
         "c.softmax_accel.autotvin_mem.dat"
         "c.softmax_accel.autotvin_input_base.dat"
         "c.softmax_accel.autotvin_prob_base.dat"
         "c.softmax_accel.autotvin_dbg_base.dat"
         "c.softmax_accel.autotvin_n.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.softmax_accel.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
