...
set C_modelArgList {
	...
	{ zext_ln342 int 31 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "trunc_ln", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln342", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ prob_stream_din sc_out sc_lv 132 signal 7 } 
	{ prob_stream_full_n sc_in sc_logic 1 signal 7 } 
	{ prob_stream_write sc_out sc_logic 1 signal 7 } 
	{ prob_stream_num_data_valid sc_in sc_lv 32 signal 7 } 
	{ prob_stream_fifo_cap sc_in sc_lv 32 signal 7 } 
	{ trunc_ln sc_in sc_lv 7 signal 0 } 
	{ n sc_in sc_lv 9 signal 1 } 
	{ exp_buf_0_address0 sc_out sc_lv 6 signal 2 } 
	{ exp_buf_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ exp_buf_0_q0 sc_in sc_lv 32 signal 2 } 
	{ zext_ln342 sc_in sc_lv 31 signal 3 } 
	{ exp_buf_1_address0 sc_out sc_lv 6 signal 4 } 
	{ exp_buf_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ exp_buf_1_q0 sc_in sc_lv 32 signal 4 } 
	{ exp_buf_2_address0 sc_out sc_lv 6 signal 5 } 
	{ exp_buf_2_ce0 sc_out sc_logic 1 signal 5 } 
	{ exp_buf_2_q0 sc_in sc_lv 32 signal 5 } 
	{ exp_buf_3_address0 sc_out sc_lv 6 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln342", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "zext_ln342", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln342 { ap_stable {  { zext_ln342 in_data 0 31 } } }
