# 1 "../hls_riscv/RISCV-RV32I-H1/riscv32i.cc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../hls_riscv/RISCV-RV32I-H1/riscv32i.cc" 2





# 1 "../hls_riscv/RISCV-RV32I-H1/riscv32i.h" 1
...
# 8 "../hls_riscv/RISCV-RV32I-H1/riscv32i.h" 2
...
# 9 "../hls_riscv/RISCV-RV32I-H1/riscv32i.h" 2
# 32 "../hls_riscv/RISCV-RV32I-H1/riscv32i.h"
...
# 109 "../hls_riscv/RISCV-RV32I-H1/riscv32i.h"
...
# 7 "../hls_riscv/RISCV-RV32I-H1/riscv32i.cc" 2
...
# 8 "../hls_riscv/RISCV-RV32I-H1/riscv32i.cc" 2
# 19 "../hls_riscv/RISCV-RV32I-H1/riscv32i.cc"
__attribute__((sdx_kernel("cpu", 0))) void cpu(arch_t mem[(1 << 10)], volatile strb_t* pstrb) {
#line 1 "directive"
...
#pragma HLS RESOURCE variable=mem core=RAM_1P_BRAM
 ...
 arch_t reg_file[(1 << 5)];
  ...
  VITIS_LOOP_27_1: for (int i = 0; i < (1 << 5); i++)
    reg_file[i] = 0;
  ...
  printf("PC = %08x\n", (uint32_t) pc);
  VITIS_LOOP_249_2: for (int i = 0; i < (1 << 5); i++)
