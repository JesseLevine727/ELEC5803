...
output   ap_idle;
output   ap_ready;
input  [31:0] prob_stream_dout;
input   prob_stream_empty_n;
output   prob_stream_read;
input  [5:0] prob_stream_num_data_valid;
input  [5:0] prob_stream_fifo_cap;
...
reg   [63:0] gmem_addr_reg_222;
reg   [31:0] prob_stream_read_reg_229;
reg    ap_block_pp0_stage0_11001_grp1;
wire  signed [63:0] sext_ln224_fu_196_p1;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_11001_grp2;
reg    ap_block_pp0_stage0_01001_grp1;
reg    ap_block_pp0_stage0_11001_grp4;
reg   [8:0] i_fu_82;
wire   [8:0] add_ln222_fu_148_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_i_1;
wire   [7:0] trunc_ln224_fu_154_p1;
wire   [30:0] pr_w_cast_fu_130_p1;
wire   [30:0] zext_ln224_fu_158_p1;
wire   [30:0] add_ln224_fu_162_p2;
wire   [32:0] shl_ln_fu_168_p3;
wire   [63:0] zext_ln224_1_fu_176_p1;
wire   [63:0] add_ln224_1_fu_180_p2;
wire   [61:0] trunc_ln224_1_fu_186_p4;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_258)) begin
        if ((icmp_ln222_fu_142_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln222_fu_142_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_grp4) & (1'b0 == ap_block_pp0_stage0_subdone_grp4_done_reg))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001_grp4) & (1'b0 == ap_block_pp0_stage0_subdone_grp4_done_reg))) begin
...
assign add_ln222_fu_148_p2 = (ap_sig_allocacmp_i_1 + 9'd1);

assign add_ln224_1_fu_180_p2 = (zext_ln224_1_fu_176_p1 + mem);

assign add_ln224_fu_162_p2 = (pr_w_cast_fu_130_p1 + zext_ln224_fu_158_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = ((ap_done_reg == 1'b1) | ((prob_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp4_done_reg) & (m_axi_gmem_0_BVALID == 1'b0)) | ((m_axi_gmem_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((m_axi_gmem_0_AWREADY == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg)) | ((prob_stream_empty_n == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)))) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((ap_done_reg == 1'b1) | ((m_axi_gmem_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)) | ((prob_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp2 = ((ap_done_reg == 1'b1) | ((m_axi_gmem_0_AWREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp4 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp4_done_reg) & (m_axi_gmem_0_BVALID == 1'b0)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end
...
always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp4_done_reg) & (m_axi_gmem_0_BVALID == 1'b0)) | ((m_axi_gmem_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((m_axi_gmem_0_AWREADY == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg)) | ((prob_stream_empty_n == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)))) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp1 = ((ap_done_reg == 1'b1) | ((m_axi_gmem_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)) | ((prob_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp2 = ((ap_done_reg == 1'b1) | ((m_axi_gmem_0_AWREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp4 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp4_done_reg) & (m_axi_gmem_0_BVALID == 1'b0)) | ((ap_start_int == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end
...
always @ (*) begin
    ap_condition_258 = ((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001));
end
...
assign icmp_ln222_fu_142_p2 = ((ap_sig_allocacmp_i_1 == n) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_AWADDR = gmem_addr_reg_222;
...
assign m_axi_gmem_0_WDATA = prob_stream_read_reg_229;
...
assign pr_w_cast_fu_130_p1 = pr_w;

assign sext_ln224_fu_196_p1 = $signed(trunc_ln224_1_fu_186_p4);

assign shl_ln_fu_168_p3 = {{add_ln224_fu_162_p2}, {2'd0}};

assign trunc_ln224_1_fu_186_p4 = {{add_ln224_1_fu_180_p2[63:2]}};

assign trunc_ln224_fu_154_p1 = ap_sig_allocacmp_i_1[7:0];

assign zext_ln224_1_fu_176_p1 = shl_ln_fu_168_p3;

assign zext_ln224_fu_158_p1 = trunc_ln224_fu_154_p1;
