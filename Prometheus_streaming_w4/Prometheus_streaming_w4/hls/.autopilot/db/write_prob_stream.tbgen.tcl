...
set portList { 
	...
	{ prob_stream_dout sc_in sc_lv 132 signal 4 } 
	{ prob_stream_empty_n sc_in sc_logic 1 signal 4 } 
	{ prob_stream_read sc_out sc_logic 1 signal 4 } 
	{ prob_stream_num_data_valid sc_in sc_lv 5 signal 4 } 
	{ prob_stream_fifo_cap sc_in sc_lv 5 signal 4 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "89"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "89"}
]}
...
set Spec2ImplPortList { 
	...
	pr_l { ap_stable {  { pr_l in_data 0 28 } } }
