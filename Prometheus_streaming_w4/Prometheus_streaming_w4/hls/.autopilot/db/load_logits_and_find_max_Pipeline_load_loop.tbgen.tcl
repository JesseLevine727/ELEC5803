...
dict set ap_memory_interface_dict logits_buf_3 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict logits_buf_2 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict logits_buf_1 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict logits_buf_0 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ blocks int 7 regular  }
	{ n int 9 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "blocks", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ blocks sc_in sc_lv 7 signal 0 } 
	{ n sc_in sc_lv 9 signal 1 } 
	{ sext_ln204 sc_in sc_lv 60 signal 3 } 
	{ logits_buf_3_address1 sc_out sc_lv 6 signal 4 } 
	{ logits_buf_3_ce1 sc_out sc_logic 1 signal 4 } 
	{ logits_buf_3_we1 sc_out sc_logic 1 signal 4 } 
	{ logits_buf_3_d1 sc_out sc_lv 32 signal 4 } 
	{ logits_buf_2_address1 sc_out sc_lv 6 signal 5 } 
	{ logits_buf_2_ce1 sc_out sc_logic 1 signal 5 } 
	{ logits_buf_2_we1 sc_out sc_logic 1 signal 5 } 
	{ logits_buf_2_d1 sc_out sc_lv 32 signal 5 } 
	{ logits_buf_1_address1 sc_out sc_lv 6 signal 6 } 
	{ logits_buf_1_ce1 sc_out sc_logic 1 signal 6 } 
	{ logits_buf_1_we1 sc_out sc_logic 1 signal 6 } 
	{ logits_buf_1_d1 sc_out sc_lv 32 signal 6 } 
	{ logits_buf_0_address1 sc_out sc_lv 6 signal 7 } 
	{ logits_buf_0_ce1 sc_out sc_logic 1 signal 7 } 
	{ logits_buf_0_we1 sc_out sc_logic 1 signal 7 } 
	{ logits_buf_0_d1 sc_out sc_lv 32 signal 7 } 
	{ max_x_out sc_out sc_lv 32 signal 8 } 
	{ max_x_out_ap_vld sc_out sc_logic 1 outvld 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "blocks", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "blocks", "role": "default" }} , 
...
set Spec2ImplPortList { 
	blocks { ap_none {  { blocks in_data 0 7 } } }
