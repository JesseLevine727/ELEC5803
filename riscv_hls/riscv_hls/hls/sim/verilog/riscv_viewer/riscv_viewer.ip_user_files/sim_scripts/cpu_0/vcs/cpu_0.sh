...
#                script (type 'cpu_0.sh -help' for more information).
#
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../../../2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cpu_0 xil_defaultlib.glbl -o cpu_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cpu_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cpu_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cpu_0_simv.daidir vcs_lib c.obj)
