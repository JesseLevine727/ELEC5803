...
if {[file isfile softmax_accel.autotvin.dat]} {
	file delete -force softmax_accel.autotvin.dat
}

if {[file isfile softmax_accel.autotvout.dat]} {
	file delete -force softmax_accel.autotvout.dat
}
