...
//
//==============================================================
`ifndef SOFTMAX_ACCEL_SCOREBOARD__SV                                                       
    `define SOFTMAX_ACCEL_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class softmax_accel_scoreboard extends uvm_component;                                        
                                                                                               
        softmax_accel_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(softmax_accel_scoreboard)                                     
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                forever begin
                    ...
                    void'(refm.mem_blk_pages_control_input_base.pages.pop_front());
                    void'(refm.mem_blk_pages_control_prob_base.pages.pop_front());
                    void'(refm.mem_blk_pages_control_dbg_base.pages.pop_front());
