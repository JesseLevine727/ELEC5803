set moduleName softmax_accel_Pipeline_VITIS_LOOP_202_3
set isTopModule 0
...
set cdfgNum 6
set C_modelName {softmax_accel_Pipeline_VITIS_LOOP_202_3}
...
set C_modelArgList {
	...
	{ exp_buf int 32 regular {array 256 { 1 } 1 1 }  }
	{ zext_ln208 int 31 regular  }
	{ zext_ln202_1 int 30 regular  }
	{ mem int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "zext_ln208", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln202_1", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ exp_buf_q0 sc_in sc_lv 32 signal 2 } 
	{ zext_ln208 sc_in sc_lv 31 signal 3 } 
	{ zext_ln202_1 sc_in sc_lv 30 signal 4 } 
	{ mem sc_in sc_lv 64 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln208", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "zext_ln208", "role": "default" }} , 
 	{ "name": "zext_ln202_1", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "zext_ln202_1", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10", "Max" : "265"}
	, {"Name" : "Interval", "Min" : "10", "Max" : "265"}
]}
...
set Spec2ImplPortList { 
	...
	exp_buf { ap_memory {  { exp_buf_address0 mem_address 1 8 }  { exp_buf_ce0 mem_ce 1 1 }  { exp_buf_q0 mem_dout 0 32 } } }
	zext_ln208 { ap_none {  { zext_ln208 in_data 0 31 } } }
	zext_ln202_1 { ap_none {  { zext_ln202_1 in_data 0 30 } } }
