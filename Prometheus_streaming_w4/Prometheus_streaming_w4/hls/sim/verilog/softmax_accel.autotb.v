...
`define AUTOTB_DUT      softmax_accel
`define AUTOTB_DUT_INST AESL_inst_softmax_accel
`define AUTOTB_TOP      apatb_softmax_accel_top
`define AUTOTB_LAT_RESULT_FILE "softmax_accel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "softmax_accel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_softmax_accel_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.90

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_mem 1
`define AESL_DEPTH_input_base 1
`define AESL_DEPTH_prob_base 1
`define AESL_DEPTH_dbg_base 1
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.softmax_accel.autotvin_gmem.dat"
`define AUTOTB_TVIN_mem_out_wrapc  "../tv/rtldatafile/rtl.softmax_accel.autotvin_mem.dat"
`define AUTOTB_TVIN_input_base_out_wrapc  "../tv/rtldatafile/rtl.softmax_accel.autotvin_input_base.dat"
`define AUTOTB_TVIN_prob_base_out_wrapc  "../tv/rtldatafile/rtl.softmax_accel.autotvin_prob_base.dat"
`define AUTOTB_TVIN_dbg_base_out_wrapc  "../tv/rtldatafile/rtl.softmax_accel.autotvin_dbg_base.dat"
`define AUTOTB_TVIN_n_out_wrapc  "../tv/rtldatafile/rtl.softmax_accel.autotvin_n.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.softmax_accel.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.softmax_accel.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 276;
parameter LENGTH_dbg_base = 1;
parameter LENGTH_gmem = 4096;
parameter LENGTH_input_base = 1;
parameter LENGTH_mem = 1;
parameter LENGTH_n = 1;
parameter LENGTH_prob_base = 1;
