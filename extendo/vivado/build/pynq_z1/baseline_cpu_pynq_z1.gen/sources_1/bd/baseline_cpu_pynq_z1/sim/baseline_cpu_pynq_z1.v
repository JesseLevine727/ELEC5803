...
//Date        : Wed Mar 18 19:08:38 2026
//Host        : gondor running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target baseline_cpu_pynq_z1.bd
//Design      : baseline_cpu_pynq_z1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "baseline_cpu_pynq_z1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=baseline_cpu_pynq_z1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "baseline_cpu_pynq_z1.hwdef" *) 
module baseline_cpu_pynq_z1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  wire [0:0]axi_gpio_ctrl_0_gpio_io_o;
  wire [31:0]baseline_cpu_0_BRAM_PORT_ADDR;
  wire baseline_cpu_0_BRAM_PORT_CLK;
  wire [31:0]baseline_cpu_0_BRAM_PORT_DIN;
  wire [31:0]baseline_cpu_0_BRAM_PORT_DOUT;
  wire baseline_cpu_0_BRAM_PORT_EN;
  wire baseline_cpu_0_BRAM_PORT_RST;
  wire [3:0]baseline_cpu_0_BRAM_PORT_WE;
  wire [31:0]baseline_cpu_0_status;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > baseline_cpu_pynq_z1 blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  baseline_cpu_pynq_z1_axi_bram_ctrl_0_0 axi_bram_ctrl_0
       (.bram_addr_a(axi_bram_ctrl_0_BRAM_PORTA_ADDR),
        ...
        .s_axi_aresetn(rst_ps7_0_84M_peripheral_aresetn),
  ...
  baseline_cpu_pynq_z1_axi_gpio_ctrl_0_0 axi_gpio_ctrl_0
       (.gpio_io_i(1'b0),
        .gpio_io_o(axi_gpio_ctrl_0_gpio_io_o),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  baseline_cpu_pynq_z1_axi_gpio_status_0_0 axi_gpio_status_0
       (.gpio_io_i(baseline_cpu_0_status),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  baseline_cpu_pynq_z1_baseline_cpu_0_0 baseline_cpu_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst(rst_ps7_0_84M_peripheral_reset),
        .bram_addr(baseline_cpu_0_BRAM_PORT_ADDR),
        .bram_clk(baseline_cpu_0_BRAM_PORT_CLK),
        .bram_din(baseline_cpu_0_BRAM_PORT_DIN),
        .bram_dout(baseline_cpu_0_BRAM_PORT_DOUT),
        .bram_en(baseline_cpu_0_BRAM_PORT_EN),
        .bram_rst(baseline_cpu_0_BRAM_PORT_RST),
        .bram_we(baseline_cpu_0_BRAM_PORT_WE),
        .ctrl_start(axi_gpio_ctrl_0_gpio_io_o),
        .status(baseline_cpu_0_status));
  baseline_cpu_pynq_z1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(baseline_cpu_0_BRAM_PORT_ADDR),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(baseline_cpu_0_BRAM_PORT_CLK),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(baseline_cpu_0_BRAM_PORT_DIN),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(baseline_cpu_0_BRAM_PORT_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(baseline_cpu_0_BRAM_PORT_EN),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(baseline_cpu_0_BRAM_PORT_RST),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(baseline_cpu_0_BRAM_PORT_WE));
  (* BMM_INFO_PROCESSOR = "arm > baseline_cpu_pynq_z1 axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  baseline_cpu_pynq_z1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  baseline_cpu_pynq_z1_rst_ps7_0_84M_0 rst_ps7_0_84M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(processing_system7_0_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
        .peripheral_aresetn(rst_ps7_0_84M_peripheral_aresetn),
        .peripheral_reset(rst_ps7_0_84M_peripheral_reset),
        .slowest_sync_clk(processing_system7_0_FCLK_CLK0));
  baseline_cpu_pynq_z1_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aresetn(rst_ps7_0_84M_peripheral_aresetn));
endmodule
