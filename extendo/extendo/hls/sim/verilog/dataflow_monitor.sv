...
input logic finish
    ...
    assign pp_loop_intf_1.pre_loop_state0 = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_ST_fsm_state1;
    assign pp_loop_intf_1.pre_states_valid = 1'b1;
    assign pp_loop_intf_1.post_loop_state0 = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_ST_fsm_state5;
    assign pp_loop_intf_1.post_states_valid[0] = 1'b1;
    assign pp_loop_intf_1.post_loop_state1 = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_ST_fsm_state6;
    assign pp_loop_intf_1.post_states_valid[1] = 1'b1;
    assign pp_loop_intf_1.iter_start_state = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_ST_fsm_pp0_stage0;
    assign pp_loop_intf_1.iter_start_enable = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_enable_reg_pp0_iter0;
    assign pp_loop_intf_1.iter_start_block = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_block_pp0_stage0_subdone;
    assign pp_loop_intf_1.iter_end_state = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_ST_fsm_pp0_stage0;
    assign pp_loop_intf_1.iter_end_enable = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_enable_reg_pp0_iter1;
    assign pp_loop_intf_1.iter_end_block = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_block_pp0_stage0_subdone;
    assign pp_loop_intf_1.loop_quit_state = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_ST_fsm_pp0_stage0;
    assign pp_loop_intf_1.quit_at_end = 1'b1;
    assign pp_loop_intf_1.cur_state = AESL_inst_cpu.grp_cpu_Pipeline_PROGRAM_LOOP_fu_187.ap_CS_fsm;
