...
module sv_module_top;
    ...
    axi_if #(64,16,8,3,1)  axi_gmem_if (.clk  (apatb_softmax_accel_top.AESL_clock), .rst(apatb_softmax_accel_top.AESL_reset));
    ...
    initial begin
        uvm_config_db #( virtual axi_if#(64,16,8,3,1) )::set(null, "uvm_test_top.top_env.axi_master_gmem.*", "vif", axi_gmem_if);
    end
