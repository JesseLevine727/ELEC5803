...
$(ObjDir)/tb_mlp_infer_softmax_2samples.cc_pre.cc.tb.o : tb_mlp_infer_softmax_2samples.cc_pre.cc.tb.cc $(ObjDir)/.dir
	$(Echo) "   Compiling tb_mlp_infer_softmax_2samples.cc_pre.cc.tb.cc" $(AVE_DIR_DLOG)
