...
reg   [8:0] i_2_reg_208_pp0_iter1_reg;
reg   [0:0] icmp_ln135_reg_214;
reg   [31:0] x_reg_218;
wire   [63:0] zext_ln135_fu_152_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [31:0] max_x_fu_64;
wire   [31:0] max_x_2_fu_172_p3;
wire    ap_loop_init;
reg    ap_loop_exit_ready_pp0_iter1_reg;
reg   [8:0] i_fu_68;
wire   [8:0] add_ln135_fu_132_p2;
reg   [8:0] ap_sig_allocacmp_i_2;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp0;
reg    logits_buf_we0_local;
reg    logits_buf_ce0_local;
wire   [0:0] icmp_ln139_fu_156_p2;
wire   [0:0] icmp_ln139_1_fu_161_p2;
wire   [0:0] or_ln139_fu_166_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln135_fu_126_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln135_fu_126_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        logits_buf_we0_local = 1'b1;
    end else begin
        logits_buf_we0_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln135_reg_214 == 1'd1))) begin
...
assign add_ln135_fu_132_p2 = (ap_sig_allocacmp_i_2 + 9'd1);
...
assign icmp_ln135_fu_126_p2 = ((ap_sig_allocacmp_i_2 == n) ? 1'b1 : 1'b0);

assign icmp_ln139_1_fu_161_p2 = (($signed(x_reg_218) > $signed(max_x_fu_64)) ? 1'b1 : 1'b0);

assign icmp_ln139_fu_156_p2 = ((i_2_reg_208_pp0_iter1_reg == 9'd0) ? 1'b1 : 1'b0);

assign logits_buf_address0 = zext_ln135_fu_152_p1;

assign logits_buf_ce0 = logits_buf_ce0_local;

assign logits_buf_d0 = x_reg_218;

assign logits_buf_we0 = logits_buf_we0_local;
...
assign max_x_2_fu_172_p3 = ((or_ln139_fu_166_p2[0:0] == 1'b1) ? x_reg_218 : max_x_fu_64);

assign max_x_out = max_x_fu_64;

assign or_ln139_fu_166_p2 = (icmp_ln139_fu_156_p2 | icmp_ln139_1_fu_161_p2);

assign zext_ln135_fu_152_p1 = i_2_reg_208_pp0_iter1_reg;
