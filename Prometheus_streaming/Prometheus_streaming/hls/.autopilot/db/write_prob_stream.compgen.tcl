...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { prob_stream_dout { I 32 vector } prob_stream_empty_n { I 1 bit } prob_stream_read { O 1 bit } prob_stream_num_data_valid { I 6 vector } prob_stream_fifo_cap { I 6 vector } } \
} "
}
...
set InstName softmax_accel_flow_control_loop_pipe_U
set CompName softmax_accel_flow_control_loop_pipe
