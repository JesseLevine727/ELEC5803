...
// Vivado-facing wrapper for the standalone extendo CPU baseline.
//
// This wrapper:
// 1. Converts the HLS ap_memory port into a BRAM controller port.
// 2. Latches the single-cycle ap_done pulse for safe software polling.
...
module baseline_cpu_wrapper (
    ...
    (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORT, MASTER_TYPE BRAM_CTRL, MEM_SIZE 262144, MEM_WIDTH 32, READ_WRITE_MODE READ_WRITE" *)
  ...
  wire [15:0] hls_mem_address0;
  wire        hls_mem_ce0;
  wire        hls_mem_we0;
  wire [31:0] hls_mem_d0;
  wire [31:0] hls_mem_q0;
  wire        hls_ap_done;
  wire        hls_ap_idle;
  wire        hls_ap_ready;
  ...
  always @(posedge ap_clk) begin
    if (ap_rst) begin
      ...
      if (start_pulse) begin
        ...
        cycle_latched <= cycle_count + 28'd1;
