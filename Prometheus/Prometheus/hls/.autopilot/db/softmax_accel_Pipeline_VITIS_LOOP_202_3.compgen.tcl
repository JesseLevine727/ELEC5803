...
set name softmax_accel_mul_32ns_31ns_62_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename exp_buf \
    op interface \
    ports { exp_buf_address0 { O 8 vector } exp_buf_ce0 { O 1 bit } exp_buf_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln202_1 { I 30 vector } } \
} "
}
