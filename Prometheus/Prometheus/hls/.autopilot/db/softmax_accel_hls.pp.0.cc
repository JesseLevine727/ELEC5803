...
# 2 "<built-in>" 2
# 1 "softmax_accel_hls.cc" 2
# 18 "softmax_accel_hls.cc"
...
# 19 "softmax_accel_hls.cc" 2
# 1 "/home/elfo/Documents/2025.1/Vitis/common/technology/autopilot/hls_stream.h" 1
# 12 "/home/elfo/Documents/2025.1/Vitis/common/technology/autopilot/hls_stream.h"
# 1 "/home/elfo/Documents/2025.1/Vitis/common/technology/autopilot/hls_stream_39.h" 1
# 23 "/home/elfo/Documents/2025.1/Vitis/common/technology/autopilot/hls_stream_39.h"
namespace hls {
# 49 "/home/elfo/Documents/2025.1/Vitis/common/technology/autopilot/hls_stream_39.h"
...
# 13 "/home/elfo/Documents/2025.1/Vitis/common/technology/autopilot/hls_stream.h" 2
# 20 "softmax_accel_hls.cc" 2
...
#pragma HLS INLINE
 ap_int<64> p = (ap_int<64>)a * (ap_int<64>)b;
  p += (1LL << 15);
  return (ap_int<32>)(p >> 16);
}
...
#pragma HLS INLINE
 if (sum_q16 == 0) return 0x7FFFFFFF;
  ...
  VITIS_LOOP_117_1: for (int b = 31; b >= 0; --b) {
#pragma HLS UNROLL
...
extern "C" {
__attribute__((sdx_kernel("softmax_accel", 0))) void softmax_accel(volatile ap_uint<32> *mem,
                   uint32_t input_base,
                   uint32_t prob_base,
                   uint32_t dbg_base,
                   uint32_t n)
{
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=softmax_accel
# 159 "softmax_accel_hls.cc"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 if (n == 0) return;
  ...
  VITIS_LOOP_177_1: for (uint32_t i = 1; i < n; i++) {
#pragma HLS PIPELINE II=1
 ap_int<32> xi = (ap_int<32>)mem[in_w + i];
  ...
  ap_uint<32> exp_buf[256];
#pragma HLS BIND_STORAGE variable=exp_buf type=ram_1p impl=bram

 ap_uint<64> sum64 = 0;
  VITIS_LOOP_188_2: for (uint32_t i = 0; i < n; i++) {
#pragma HLS PIPELINE II=1
 ap_int<32> xi = (ap_int<32>)mem[in_w + i];
    ap_int<32> x = xi - max_x;
  ...
  VITIS_LOOP_202_3: for (uint32_t i = 0; i < n; i++) {
#pragma HLS PIPELINE II=1


 ap_uint<64> prod = (ap_uint<64>)exp_buf[i] * (ap_uint<64>)inv_sum_q30;
    ap_uint<32> p_q16 = (ap_uint<32>)(prod >> 30);
    mem[pr_w + i] = p_q16;
  }
  ...
  int msb = 31;
  VITIS_LOOP_215_4: for (int b = 31; b >= 0; --b) {
#pragma HLS UNROLL
