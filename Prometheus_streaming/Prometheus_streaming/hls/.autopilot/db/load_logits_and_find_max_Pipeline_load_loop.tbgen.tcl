...
dict set ap_memory_interface_dict logits_buf { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ n int 9 regular  }
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln135 int 62 regular  }
	{ logits_buf int 32 regular {array 256 { 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "n", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln135", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "logits_buf", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ n sc_in sc_lv 9 signal 0 } 
	{ sext_ln135 sc_in sc_lv 62 signal 2 } 
	{ logits_buf_address0 sc_out sc_lv 8 signal 3 } 
	{ logits_buf_ce0 sc_out sc_logic 1 signal 3 } 
	{ logits_buf_we0 sc_out sc_logic 1 signal 3 } 
	{ logits_buf_d0 sc_out sc_lv 32 signal 3 } 
	{ max_x_out sc_out sc_lv 32 signal 4 } 
	{ max_x_out_ap_vld sc_out sc_logic 1 outvld 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln135", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln135", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln135 { ap_none {  { sext_ln135 in_data 0 62 } } }
	logits_buf { ap_memory {  { logits_buf_address0 mem_address 1 8 }  { logits_buf_ce0 mem_ce 1 1 }  { logits_buf_we0 mem_we 1 1 }  { logits_buf_d0 mem_din 1 32 } } }
