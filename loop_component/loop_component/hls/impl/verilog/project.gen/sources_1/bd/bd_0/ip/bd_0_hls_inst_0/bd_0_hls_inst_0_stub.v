...
(* CHECK_LICENSE_TYPE = "bd_0_hls_inst_0,cpu,{}" *) (* CORE_GENERATION_INFO = "bd_0_hls_inst_0,cpu,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=cpu,x_ipVersion=1.0,x_ipCoreRevision=2114485130,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
/* synthesis syn_black_box black_box_pad_pin="mem_ce0,mem_we0,ap_rst,ap_done,ap_idle,ap_ready,ap_start,mem_address0[12:0],mem_d0[31:0],mem_q0[31:0],pstrb[3:0]" */
