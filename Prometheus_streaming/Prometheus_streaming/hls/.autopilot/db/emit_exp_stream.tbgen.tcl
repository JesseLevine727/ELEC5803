...
set C_modelArgList {
	...
	{ exp_stream int 32 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "logits_buf", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "exp_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ exp_stream_din sc_out sc_lv 32 signal 3 } 
	{ exp_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ exp_stream_write sc_out sc_logic 1 signal 3 } 
	{ exp_stream_num_data_valid sc_in sc_lv 32 signal 3 } 
	{ exp_stream_fifo_cap sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "exp_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "exp_stream", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "11", "Max" : "266"}
	, {"Name" : "Interval", "Min" : "11", "Max" : "266"}
]}
...
set Spec2ImplPortList { 
	logits_buf { ap_stable {  { logits_buf_address0 mem_address 1 8 }  { logits_buf_ce0 mem_ce 1 1 }  { logits_buf_q0 mem_dout 0 32 } } }
	n { ap_stable {  { n in_data 0 9 } } }
	max_x { ap_stable {  { max_x in_data 0 32 } } }
	exp_stream { ap_fifo {  { exp_stream_din fifo_data_in 1 32 }  { exp_stream_full_n fifo_status 0 1 }  { exp_stream_write fifo_port_we 1 1 }  { exp_stream_num_data_valid fifo_status_num_data_valid 0 32 }  { exp_stream_fifo_cap fifo_update 0 32 } } }
}
