...
#
# Script generated by Vivado on Tue Jan 20 11:09:40 EST 2026
...
#
# Usage        : cpu_0.sh
#                cpu_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cpu_0.sh [-reset_run]
#                cpu_0.sh [-reset_log]
#                cpu_0.sh [-help]
#
...
export RDI_DATADIR="/home/elfo/Documents/2025.1/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "cpu_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cpu_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cpu_0 xil_defaultlib.cpu_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cpu_0 -key {Behavioral:sim_1:Functional:cpu_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/elfo/Documents/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cpu_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cpu_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cpu_0.sh [-help]\n\
Usage: cpu_0.sh [-step]\n\
Usage: cpu_0.sh [-lib_map_path]\n\
Usage: cpu_0.sh [-reset_run]\n\
Usage: cpu_0.sh [-reset_log]\n\
Usage: cpu_0.sh [-keep_index]\n\
Usage: cpu_0.sh [-noclean_files]\n\n\
