...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_full_blocks \
    op interface \
    ports { full_blocks { I 7 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { prob_stream_dout { I 132 vector } prob_stream_empty_n { I 1 bit } prob_stream_read { O 1 bit } prob_stream_num_data_valid { I 5 vector } prob_stream_fifo_cap { I 5 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_pr_l_cast \
    op interface \
    ports { pr_l_cast { I 28 vector } } \
} "
}
