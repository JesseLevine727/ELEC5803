...
entity softmax_accel_softmax_accel_Pipeline_VITIS_LOOP_177_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of softmax_accel_softmax_accel_Pipeline_VITIS_LOOP_177_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln177_fu_113_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln177_reg_180 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal xi_reg_184 : STD_LOGIC_VECTOR (31 downto 0);
    signal max_x_1_fu_58 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal max_x_2_fu_144_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal ap_loop_exit_ready_pp0_iter1_reg : STD_LOGIC;
    signal i_fu_62 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal add_ln177_fu_119_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_sig_allocacmp_i_2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp0 : BOOLEAN;
    signal icmp_ln180_fu_139_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln177_fu_113_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_62 <= add_ln177_fu_119_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_fu_62 <= ap_const_lv9_1;
                end if;
            end if; 
        end if;
    end process;

    max_x_1_fu_58_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0))) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    max_x_1_fu_58 <= max_x_2_fu_144_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln177_reg_180 <= icmp_ln177_fu_113_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln177_fu_119_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_2) + unsigned(ap_const_lv9_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln177_fu_113_p2)
    begin
        if (((icmp_ln177_fu_113_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_i_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_loop_init, i_fu_62, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_i_2 <= ap_const_lv9_1;
        else 
    ...
    icmp_ln177_fu_113_p2 <= "1" when (unsigned(ap_sig_allocacmp_i_2) < unsigned(select_ln169)) else "0";
    icmp_ln180_fu_139_p2 <= "1" when (signed(xi_reg_184) > signed(max_x_1_fu_58)) else "0";
    ...
    max_x_1_out <= max_x_1_fu_58;

    max_x_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg, icmp_ln177_reg_180, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (icmp_ln177_reg_180 = ap_const_lv1_0))) then 
            max_x_1_out_ap_vld <= ap_const_logic_1;
        else 
            max_x_1_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    max_x_2_fu_144_p3 <= 
        xi_reg_184 when (icmp_ln180_fu_139_p2(0) = '1') else 
        max_x_1_fu_58;
end behav;
