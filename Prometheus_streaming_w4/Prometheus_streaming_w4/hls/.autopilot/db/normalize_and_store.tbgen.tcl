...
set C_modelArgList {
	...
	{ mem int 64 regular {ap_stable 0} }
	{ pr_l int 28 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "mem", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "pr_l", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ pr_l sc_in sc_lv 28 signal 2 } 
	{ n sc_in sc_lv 9 signal 3 } 
	{ exp_buf_0_address0 sc_out sc_lv 6 signal 4 } 
	{ exp_buf_0_ce0 sc_out sc_logic 1 signal 4 } 
	{ exp_buf_0_d0 sc_out sc_lv 32 signal 4 } 
	{ exp_buf_0_q0 sc_in sc_lv 32 signal 4 } 
	{ exp_buf_0_we0 sc_out sc_logic 1 signal 4 } 
	{ exp_buf_0_address1 sc_out sc_lv 6 signal 4 } 
	{ exp_buf_0_ce1 sc_out sc_logic 1 signal 4 } 
	{ exp_buf_0_d1 sc_out sc_lv 32 signal 4 } 
	{ exp_buf_0_q1 sc_in sc_lv 32 signal 4 } 
	{ exp_buf_0_we1 sc_out sc_logic 1 signal 4 } 
	{ exp_buf_1_address0 sc_out sc_lv 6 signal 5 } 
	{ exp_buf_1_ce0 sc_out sc_logic 1 signal 5 } 
	{ exp_buf_1_d0 sc_out sc_lv 32 signal 5 } 
	{ exp_buf_1_q0 sc_in sc_lv 32 signal 5 } 
	{ exp_buf_1_we0 sc_out sc_logic 1 signal 5 } 
	{ exp_buf_1_address1 sc_out sc_lv 6 signal 5 } 
	{ exp_buf_1_ce1 sc_out sc_logic 1 signal 5 } 
	{ exp_buf_1_d1 sc_out sc_lv 32 signal 5 } 
	{ exp_buf_1_q1 sc_in sc_lv 32 signal 5 } 
	{ exp_buf_1_we1 sc_out sc_logic 1 signal 5 } 
	{ exp_buf_2_address0 sc_out sc_lv 6 signal 6 } 
	{ exp_buf_2_ce0 sc_out sc_logic 1 signal 6 } 
	{ exp_buf_2_d0 sc_out sc_lv 32 signal 6 } 
	{ exp_buf_2_q0 sc_in sc_lv 32 signal 6 } 
	{ exp_buf_2_we0 sc_out sc_logic 1 signal 6 } 
	{ exp_buf_2_address1 sc_out sc_lv 6 signal 6 } 
	{ exp_buf_2_ce1 sc_out sc_logic 1 signal 6 } 
	{ exp_buf_2_d1 sc_out sc_lv 32 signal 6 } 
	{ exp_buf_2_q1 sc_in sc_lv 32 signal 6 } 
	{ exp_buf_2_we1 sc_out sc_logic 1 signal 6 } 
	{ exp_buf_3_address0 sc_out sc_lv 6 signal 7 } 
	{ exp_buf_3_ce0 sc_out sc_logic 1 signal 7 } 
	{ exp_buf_3_d0 sc_out sc_lv 32 signal 7 } 
	{ exp_buf_3_q0 sc_in sc_lv 32 signal 7 } 
	{ exp_buf_3_we0 sc_out sc_logic 1 signal 7 } 
	{ exp_buf_3_address1 sc_out sc_lv 6 signal 7 } 
	{ exp_buf_3_ce1 sc_out sc_logic 1 signal 7 } 
	{ exp_buf_3_d1 sc_out sc_lv 32 signal 7 } 
	{ exp_buf_3_q1 sc_in sc_lv 32 signal 7 } 
	{ exp_buf_3_we1 sc_out sc_logic 1 signal 7 } 
	{ inv_sum_q30 sc_in sc_lv 31 signal 8 } 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst sc_in sc_logic 1 reset -1 active_high_sync } 
	{ n_ap_vld sc_in sc_logic 1 invld 3 } 
	{ inv_sum_q30_ap_vld sc_in sc_logic 1 invld 8 } 
	{ ap_start sc_in sc_logic 1 start -1 } 
	{ mem_ap_vld sc_in sc_logic 1 invld 1 } 
	{ pr_l_ap_vld sc_in sc_logic 1 invld 2 } 
...
set NewPortList {[ 
	{ "name": "m_axi_gmem_0_AWVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gmem", "role": "0_AWVALID" }} , 
 	...
 	{ "name": "pr_l", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "pr_l", "role": "default" }} , 
 	...
 	{ "name": "mem_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "mem", "role": "ap_vld" }} , 
...
set ArgLastReadFirstWriteLatency {
	normalize_and_store {
		gmem {Type IO LastRead 13 FirstWrite 2}
	...
	write_prob_stream {
		...
		n {Type I LastRead 0 FirstWrite -1}
		prob_stream {Type I LastRead 10 FirstWrite -1}}
	write_prob_stream_Pipeline_prob_write_loop {
		...
		pr_l_cast {Type I LastRead 0 FirstWrite -1}
		mem {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7", "Max" : "92"}
	, {"Name" : "Interval", "Min" : "7", "Max" : "90"}
]}
...
set Spec2ImplPortList { 
	...
	mem { ap_none {  { mem in_data 0 64 }  { mem_ap_vld in_vld 0 1 } } }
	pr_l { ap_none {  { pr_l in_data 0 28 }  { pr_l_ap_vld in_vld 0 1 } } }
	n { ap_none {  { n in_data 0 9 }  { n_ap_vld in_vld 0 1 } } }
	exp_buf_0 { ap_memory {  { exp_buf_0_address0 mem_address 1 6 }  { exp_buf_0_ce0 mem_ce 1 1 }  { exp_buf_0_d0 mem_din 1 32 }  { exp_buf_0_q0 mem_dout 0 32 }  { exp_buf_0_we0 mem_we 1 1 }  { exp_buf_0_address1 mem_address 1 6 }  { exp_buf_0_ce1 mem_ce 1 1 }  { exp_buf_0_d1 mem_din 1 32 }  { exp_buf_0_q1 mem_dout 0 32 }  { exp_buf_0_we1 mem_we 1 1 } } }
	exp_buf_1 { ap_memory {  { exp_buf_1_address0 mem_address 1 6 }  { exp_buf_1_ce0 mem_ce 1 1 }  { exp_buf_1_d0 mem_din 1 32 }  { exp_buf_1_q0 mem_dout 0 32 }  { exp_buf_1_we0 mem_we 1 1 }  { exp_buf_1_address1 mem_address 1 6 }  { exp_buf_1_ce1 mem_ce 1 1 }  { exp_buf_1_d1 mem_din 1 32 }  { exp_buf_1_q1 mem_dout 0 32 }  { exp_buf_1_we1 mem_we 1 1 } } }
	exp_buf_2 { ap_memory {  { exp_buf_2_address0 mem_address 1 6 }  { exp_buf_2_ce0 mem_ce 1 1 }  { exp_buf_2_d0 mem_din 1 32 }  { exp_buf_2_q0 mem_dout 0 32 }  { exp_buf_2_we0 mem_we 1 1 }  { exp_buf_2_address1 mem_address 1 6 }  { exp_buf_2_ce1 mem_ce 1 1 }  { exp_buf_2_d1 mem_din 1 32 }  { exp_buf_2_q1 mem_dout 0 32 }  { exp_buf_2_we1 mem_we 1 1 } } }
	exp_buf_3 { ap_memory {  { exp_buf_3_address0 mem_address 1 6 }  { exp_buf_3_ce0 mem_ce 1 1 }  { exp_buf_3_d0 mem_din 1 32 }  { exp_buf_3_q0 mem_dout 0 32 }  { exp_buf_3_we0 mem_we 1 1 }  { exp_buf_3_address1 mem_address 1 6 }  { exp_buf_3_ce1 mem_ce 1 1 }  { exp_buf_3_d1 mem_din 1 32 }  { exp_buf_3_q1 mem_dout 0 32 }  { exp_buf_3_we1 mem_we 1 1 } } }
