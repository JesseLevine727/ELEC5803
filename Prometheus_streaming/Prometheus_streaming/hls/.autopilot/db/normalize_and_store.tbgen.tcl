...
set portList { 
	...
	{ exp_buf_q0 sc_in sc_lv 32 signal 4 } 
	...
	{ inv_sum_q30_ap_vld sc_in sc_logic 1 invld 5 } 
	{ ap_start sc_in sc_logic 1 start -1 } 
	{ mem_ap_vld sc_in sc_logic 1 invld 1 } 
	{ pr_w_ap_vld sc_in sc_logic 1 invld 2 } 
...
set NewPortList {[ 
	{ "name": "m_axi_gmem_0_AWVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gmem", "role": "0_AWVALID" }} , 
 	...
 	{ "name": "pr_w_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "pr_w", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	pr_w { ap_none {  { pr_w in_data 0 30 }  { pr_w_ap_vld in_vld 0 1 } } }
