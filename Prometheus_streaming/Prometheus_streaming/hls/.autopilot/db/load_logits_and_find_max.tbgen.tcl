...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "in_w", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_w sc_in sc_lv 30 signal 2 } 
	{ n sc_in sc_lv 9 signal 3 } 
	{ logits_buf_address0 sc_out sc_lv 8 signal 4 } 
	{ logits_buf_ce0 sc_out sc_logic 1 signal 4 } 
	{ logits_buf_we0 sc_out sc_logic 1 signal 4 } 
	{ logits_buf_d0 sc_out sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_w", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "in_w", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15", "Max" : "270"}
	, {"Name" : "Interval", "Min" : "15", "Max" : "270"}
]}
...
set Spec2ImplPortList { 
	...
	in_w { ap_none {  { in_w in_data 0 30 } } }
