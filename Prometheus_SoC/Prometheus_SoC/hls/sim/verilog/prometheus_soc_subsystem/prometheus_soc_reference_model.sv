...
`ifndef PROMETHEUS_SOC_REFERENCE_MODEL_SV
`define PROMETHEUS_SOC_REFERENCE_MODEL_SV

class prometheus_soc_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(prometheus_soc_reference_model)
