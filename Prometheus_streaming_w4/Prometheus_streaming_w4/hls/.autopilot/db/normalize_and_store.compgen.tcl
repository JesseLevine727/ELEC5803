...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler softmax_accel_fifo_w132_d16_A_x BINDTYPE {storage} TYPE {fifo} IMPL {memory} ALLOW_PRAGMA 1 INSTNAME {prob_stream_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_pr_l \
    op interface \
    ports { pr_l { I 28 vector } pr_l_ap_vld { I 1 bit } } \
} "
}
