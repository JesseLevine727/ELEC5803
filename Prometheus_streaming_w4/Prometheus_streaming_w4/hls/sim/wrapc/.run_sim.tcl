...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "softmax_accel.autotvin.dat"
	set constFileTvOut       "softmax_accel.autotvout.dat"
	set constFileHdlTvIn     "softmax_accel.autohdltvin.dat"
	set constFileHdlTvOut    "softmax_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
