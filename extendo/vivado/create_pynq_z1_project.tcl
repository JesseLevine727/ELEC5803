...
set rtl_dir [file normalize [file join $root_dir extendo hls impl verilog]]
set build_dir [file normalize [file join $script_dir build pynq_z1]]
set proj_name baseline_cpu_pynq_z1
set bd_name baseline_cpu_pynq_z1
set ip_repo_dir [file normalize [file join $build_dir ip_repo]]
set ip_pkg_dir [file normalize [file join $ip_repo_dir baseline_cpu_wrapper_1_0]]
...
add_files -norecurse [file join $script_dir baseline_cpu_wrapper.v]

update_compile_order -fileset sources_1
set_property top baseline_cpu_wrapper [current_fileset]
...
set_property name baseline_cpu_wrapper $core
set_property display_name {Baseline CPU Wrapper} $core
set_property description {Standalone extendo CPU wrapper with BRAM and latched status for PYNQ-Z1 integration} $core
...
lappend removable_files [file join $script_dir baseline_cpu_wrapper.v]
...
set_property -dict [list CONFIG.DATA_WIDTH {32} CONFIG.SINGLE_PORT_BRAM {1}] $axi_bram_ctrl_0
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins baseline_cpu_0/ap_clk]
connect_bd_net [get_bd_pins rst_ps7_0_84M/peripheral_reset] [get_bd_pins baseline_cpu_0/ap_rst]
...
connect_bd_intf_net [get_bd_intf_pins baseline_cpu_0/BRAM_PORT] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB]

connect_bd_net [get_bd_pins axi_gpio_ctrl_0/gpio_io_o] [get_bd_pins baseline_cpu_0/ctrl_start]
connect_bd_net [get_bd_pins baseline_cpu_0/status] [get_bd_pins axi_gpio_status_0/gpio_io_i]
