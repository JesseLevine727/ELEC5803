...
if {[file isfile prometheus_soc.autotvin.dat]} {
	file delete -force prometheus_soc.autotvin.dat
}

if {[file isfile prometheus_soc.autotvout.dat]} {
	file delete -force prometheus_soc.autotvout.dat
}
