...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename logits_buf \
    op interface \
    ports { logits_buf_address0 { O 8 vector } logits_buf_ce0 { O 1 bit } logits_buf_we0 { O 1 bit } logits_buf_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'logits_buf'"
}
}
