...
module softmax_accel_softmax_accel_Pipeline_VITIS_LOOP_177_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] max_x_1_out;
output   max_x_1_out_ap_vld;

reg ap_idle;
reg m_axi_gmem_0_RREADY;
reg max_x_1_out_ap_vld;
...
reg   [0:0] icmp_ln177_reg_180;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] xi_reg_184;
reg   [31:0] max_x_1_fu_58;
wire   [31:0] max_x_2_fu_144_p3;
wire    ap_block_pp0_stage0_grp0;
wire    ap_loop_init;
reg    ap_loop_exit_ready_pp0_iter1_reg;
reg   [8:0] i_fu_62;
wire   [8:0] add_ln177_fu_119_p2;
reg   [8:0] ap_sig_allocacmp_i_2;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp0;
wire   [0:0] icmp_ln180_fu_139_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln177_fu_113_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln177_fu_113_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln177_reg_180 == 1'd0))) begin
        max_x_1_out_ap_vld = 1'b1;
    end else begin
        max_x_1_out_ap_vld = 1'b0;
    end
end
...
assign add_ln177_fu_119_p2 = (ap_sig_allocacmp_i_2 + 9'd1);
...
assign icmp_ln177_fu_113_p2 = ((ap_sig_allocacmp_i_2 < select_ln169) ? 1'b1 : 1'b0);

assign icmp_ln180_fu_139_p2 = (($signed(xi_reg_184) > $signed(max_x_1_fu_58)) ? 1'b1 : 1'b0);
...
assign max_x_1_out = max_x_1_fu_58;

assign max_x_2_fu_144_p3 = ((icmp_ln180_fu_139_p2[0:0] == 1'b1) ? xi_reg_184 : max_x_1_fu_58);

endmodule //softmax_accel_softmax_accel_Pipeline_VITIS_LOOP_177_1
