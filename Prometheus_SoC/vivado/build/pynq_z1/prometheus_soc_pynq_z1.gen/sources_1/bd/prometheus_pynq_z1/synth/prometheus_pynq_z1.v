...
(* CORE_GENERATION_INFO = "prometheus_pynq_z1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=prometheus_pynq_z1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "prometheus_pynq_z1.hwdef" *) 
module prometheus_pynq_z1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  wire [31:0]prometheus_soc_0_BRAM_PORT_ADDR;
  wire prometheus_soc_0_BRAM_PORT_CLK;
  wire [127:0]prometheus_soc_0_BRAM_PORT_DIN;
  wire [127:0]prometheus_soc_0_BRAM_PORT_DOUT;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 128 > prometheus_pynq_z1 blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  prometheus_pynq_z1_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  prometheus_pynq_z1_axi_gpio_ctrl_0_0 axi_gpio_ctrl_0
       (.gpio_io_i(1'b0),
  ...
  prometheus_pynq_z1_axi_gpio_status_0_0 axi_gpio_status_0
       (.gpio_io_i(prometheus_soc_0_status),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  prometheus_pynq_z1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(prometheus_soc_0_BRAM_PORT_ADDR),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(prometheus_soc_0_BRAM_PORT_CLK),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(prometheus_soc_0_BRAM_PORT_DIN),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(prometheus_soc_0_BRAM_PORT_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(prometheus_soc_0_BRAM_PORT_EN),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(prometheus_soc_0_BRAM_PORT_RST),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(prometheus_soc_0_BRAM_PORT_WE));
  (* BMM_INFO_PROCESSOR = "arm > prometheus_pynq_z1 axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  prometheus_pynq_z1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  prometheus_pynq_z1_prometheus_soc_0_0 prometheus_soc_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst(rst_ps7_0_84M_peripheral_reset),
        .bram_addr(prometheus_soc_0_BRAM_PORT_ADDR),
        .bram_clk(prometheus_soc_0_BRAM_PORT_CLK),
        .bram_din(prometheus_soc_0_BRAM_PORT_DIN),
        .bram_dout(prometheus_soc_0_BRAM_PORT_DOUT),
        .bram_en(prometheus_soc_0_BRAM_PORT_EN),
        .bram_rst(prometheus_soc_0_BRAM_PORT_RST),
        .bram_we(prometheus_soc_0_BRAM_PORT_WE),
        .ctrl_start(axi_gpio_ctrl_0_gpio_io_o),
        .status(prometheus_soc_0_status));
  prometheus_pynq_z1_rst_ps7_0_84M_0 rst_ps7_0_84M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  prometheus_pynq_z1_smartconnect_0_0 smartconnect_0
