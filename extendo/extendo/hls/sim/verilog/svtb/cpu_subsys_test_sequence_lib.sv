...
//
//==============================================================
`ifndef CPU_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define CPU_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class cpu_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "cpu_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(cpu_subsys_test_sequence_lib)                                     
        ...
        virtual task body();                                                                        
            ...
            if (!uvm_config_db#(cpu_reference_model)::get(p_sequencer,"", "refm", refm))
